...
class ESP8266 {
 public:
    ...
    ESP8266(SoftwareSerial &uart, HardwareSerial &dbg);
    
    HardwareSerial* m_dbg ;
    ...
    */
    ...
    void recvEcho(uint32_t timeout) ;

    void recvRaw(char * buffer, unsigned long len, char start, uint32_t timeout) ;

    String recvString(uint32_t timeout = 1000) ;
